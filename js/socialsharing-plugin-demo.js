...
//      window.plugins.socialsharing.share('Some text');
        window.plugins.socialsharing.shareViaSMS('My cool message', function(msg) {console.log('ok: ' + msg)}, function(msg) {alert('nok: ' + msg)})
//window.plugins.socialsharing.shareViaSMS('My cool message','','');
